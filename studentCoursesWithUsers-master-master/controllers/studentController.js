...
module.exports.viewProfile = async function (req, res) {
    ...
    //if they aren't staff and they aren't the studen whose profile they are trying to view, redirect
...
module.exports.updateStudent = async function (req, res) {
    ...
    //if they arent staff and they arent the student whose profile they are tyring to view, redirect
    if(!isAdmin && !profileBelongsToUser){
        res.redirect('/')
        return
    }
